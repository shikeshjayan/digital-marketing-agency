...
function ProfileRow({
  ...
  return (
    <div
      className={`group mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center ${reverse ? "md:flex-row-reverse" : ""} bg-white border border-gray-200 rounded-lg p-6 md:p-8 hover:shadow-sm transition duration-300 cursor-pointer select-none`}>
      {/* Visual Asset Block - Centers elements natively without a bounding background block */}
      <div className="flex justify-center items-center cursor-pointer">
        <div className="w-full max-w-60 aspect-square flex items-center justify-center overflow-hidden cursor-pointer">
          {imageSrc ? (
            <img
              src={imageSrc}
          ...
          <span
            className="w-full text-6xl font-black font-mono tracking-widest text-primary uppercase py-2 flex items-center justify-center text-center cursor-pointer select-none group-hover:scale-110 transition-transform duration-500"
      ...
      <div className="text-gray-800 cursor-pointer text-center md:text-left">
        <div className="text-2xl font-extrabold text-gray-900 cursor-pointer hover:text-primary transition-colors duration-300">
          {name}
        </div>
        <div className="mt-1 text-sm font-semibold text-primary uppercase tracking-wider cursor-pointer">
          {title}
        </div>
    ...
    <div>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 space-y-12 md:space-y-16">
          {/* Welcome Banner Card */}
          <FadeIn>
            <div className="p-4 md:p-10 text-center cursor-pointer select-none">
