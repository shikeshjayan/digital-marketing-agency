      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <FadeIn delay={0}><ContactCard title="Phone" value="+91 8891212323" icon="Ph" /></FadeIn>
            <FadeIn delay={100}><ContactCard title="Mail" value="info@s.com" icon="Mail" /></FadeIn>
            <FadeIn delay={200}><ContactCard title="Address" value="Kochi, India" icon="Loc" /></FadeIn>
          </div>
